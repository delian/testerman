...
class MAP_DialoguePDUCodec(BerCodec.BerCodec):
	PDU = MapAsn.MAP_DialoguePDU
	def getSummary(self, message): return 'MAP-DialoguePDU'
CodecManager.registerCodecClass('map.MAP-DialoguePDU', MAP_DialoguePDUCodec)
